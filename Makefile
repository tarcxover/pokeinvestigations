...
# evidence_macros.h is generated by a python script
EVIDENCE_TOOL_DIR := $(TOOLS_DIR)/evidence
AUTO_GEN_TARGETS += $(INCLUDE_DIRS)/constants/evidence_macros.h $(INCLUDE_DIRS)/generated/evidence_gfx.h $(DATA_SRC_SUBDIR)/credits_list.h
...
$(INCLUDE_DIRS)/constants/evidence_macros.h: $(DATA_SRC_SUBDIR)/evidence.yaml $(EVIDENCE_TOOL_DIR)/generate.py
	uv run $(EVIDENCE_TOOL_DIR)/generate.py > $(INCLUDE_DIRS)/constants/evidence_macros.h

$(INCLUDE_DIRS)/generated/evidence_gfx.h: $(DATA_SRC_SUBDIR)/evidence.yaml $(EVIDENCE_TOOL_DIR)/generate_incbins.py | $(INCLUDE_DIRS)/generated
	uv run $(EVIDENCE_TOOL_DIR)/generate_incbins.py > $(INCLUDE_DIRS)/generated/evidence_gfx.h

$(DATA_SRC_SUBDIR)/credits_list.h: $(DATA_SRC_SUBDIR)/credits.yaml $(EVIDENCE_TOOL_DIR)/generate_credits.py
	uv run $(EVIDENCE_TOOL_DIR)/generate_credits.py > $(DATA_SRC_SUBDIR)/credits_list.h
