...
enum
{
    ...
    OBJ_EVENT_GFX_ICHIRO_INJURED,
    OBJ_EVENT_GFX_POLICEOFFICER_M,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_ICHIRO_INJURED             0x113D
#define OBJ_EVENT_PAL_TAG_POLICEOFFICER_M            0x113E
