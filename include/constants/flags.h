...
#define FLAG_AUTORUN_TOGGLE                  0x68  // Autorun state if set to TOGGLE
...
#define FLAG_HIDE_TARC3_GOZOROOM_HELPER_MON         (TARC3_RESERVED_FLAGS_START + 0x1)
...
#define FLAG_HIDE_TARC3_MAINDECK_HELPER_MON         (TARC3_RESERVED_FLAGS_START + 0x4)
#define FLAG_HIDE_TARC3_FOREDECK_HELPER_MON         (TARC3_RESERVED_FLAGS_START + 0x5)
...
#define FLAG_UNUSED_0x971                           (TARC3_RESERVED_FLAGS_START + 0x11) // Unused Flag
#define FLAG_UNUSED_0x972                           (TARC3_RESERVED_FLAGS_START + 0x12) // Unused Flag
...
#define FLAG_HIDE_TARC3_GOZO_BODY             (TARC3_RESERVED_FLAGS_START + 0x2C)
#define FLAG_HIDE_TARC3_GOZO_SUZUKI           (TARC3_RESERVED_FLAGS_START + 0x2D)
...
#define FLAG_HIDE_TARC3_DECK2_BODY                  (TARC3_RESERVED_FLAGS_START + 0x3A)
#define FLAG_HIDE_TARC3_DECK2_CAST                  (TARC3_RESERVED_FLAGS_START + 0x3B)
#define FLAG_HIDE_TARC3_DECK2_RAN                   (TARC3_RESERVED_FLAGS_START + 0x3C)
#define FLAG_HIDE_TARC3_HOLD2_CAST                  (TARC3_RESERVED_FLAGS_START + 0x3D)
#define FLAG_HIDE_TARC3_DECK2_FOLLOWERS             (TARC3_RESERVED_FLAGS_START + 0x3E)
#define FLAG_TARC3_GATHER_KITARO                    (TARC3_RESERVED_FLAGS_START + 0x3F)
#define FLAG_TARC3_GATHER_NATSUE                    (TARC3_RESERVED_FLAGS_START + 0x40)
#define FLAG_TARC3_GATHER_SUZUKI                    (TARC3_RESERVED_FLAGS_START + 0x41)
#define FLAG_TARC3_GATHER_ICHIRO                    (TARC3_RESERVED_FLAGS_START + 0x42)
#define FLAG_HIDE_TARC3_BATH_ICHIRO_UP              (TARC3_RESERVED_FLAGS_START + 0x43)
...
#define FLAG_TARC3_GOZO_FOUND_FRAME           (TARC3_RESERVED_FLAGS_START + 0x4A)
#define FLAG_TARC3_REFLECT_SUZUKI                   (TARC3_RESERVED_FLAGS_START + 0x4B)
#define FLAG_TARC3_GOZO_FOUND_LATCH           (TARC3_RESERVED_FLAGS_START + 0x4C)
#define FLAG_TARC3_HOLD_FOUND_MANIFEST              (TARC3_RESERVED_FLAGS_START + 0x4D)
#define FLAG_TARC3_GOZO_SEARCH_BED            (TARC3_RESERVED_FLAGS_START + 0x4E)
#define FLAG_TARC3_GOZO_SEARCH_COUCH          (TARC3_RESERVED_FLAGS_START + 0x4F)
#define FLAG_TARC3_GOZO_SEARCH_BIN            (TARC3_RESERVED_FLAGS_START + 0x50)
#define FLAG_TARC3_GOZO_FOUND_WEAPON          (TARC3_RESERVED_FLAGS_START + 0x51)
#define FLAG_TARC3_GOZO_FOUND_MEDICATION      (TARC3_RESERVED_FLAGS_START + 0x52)
#define FLAG_TARC3_GOZO_FOUND_CRUMBS          (TARC3_RESERVED_FLAGS_START + 0x53)
#define FLAG_TARC3_GOZO_FOUND_WINDOW          (TARC3_RESERVED_FLAGS_START + 0x54)
#define FLAG_TARC3_GOZO_FOUND_BODY            (TARC3_RESERVED_FLAGS_START + 0x55)
#define FLAG_TARC3_DINING_FOUND_PLATE               (TARC3_RESERVED_FLAGS_START + 0x56)
#define FLAG_TARC3_REFLECT_GOZO_SUZUKI_1      (TARC3_RESERVED_FLAGS_START + 0x57)
#define FLAG_TARC3_REFLECT_GOZO_SUZUKI_2      (TARC3_RESERVED_FLAGS_START + 0x58)
#define FLAG_TARC3_REFLECT_GOZO_SUZUKI_3      (TARC3_RESERVED_FLAGS_START + 0x59)
#define FLAG_TARC3_REFLECT_HOLD_CS5                 (TARC3_RESERVED_FLAGS_START + 0x5A)
...
#define FLAG_TARC3_ELEC_FOUND_LATCH                 (TARC3_RESERVED_FLAGS_START + 0x5E)
...
#define FLAG_TARC3_ICHIRO_FOUND_LEG                 (TARC3_RESERVED_FLAGS_START + 0x62)
#define FLAG_TARC3_ICHIRO_FOUND_LIE                 (TARC3_RESERVED_FLAGS_START + 0x63)
#define FLAG_TARC3_GOZO_FOUND_TRAIL           (TARC3_RESERVED_FLAGS_START + 0x64)
#define FLAG_TARC3_REFLECT_GATHER_NATSUE            (TARC3_RESERVED_FLAGS_START + 0x65)
#define FLAG_TARC3_GOZO_RECONSTRUCTED         (TARC3_RESERVED_FLAGS_START + 0x66)
#define FLAG_TARC3_HOLD_FOUND_DECKPLAN              (TARC3_RESERVED_FLAGS_START + 0x67)
#define FLAG_TARC3_GOZO_FOUND_RESIDUE         (TARC3_RESERVED_FLAGS_START + 0x68)
...
#define FLAG_HIDE_TARC3_NIGHT_CAST                  (TARC3_RESERVED_FLAGS_START + 0x88)
#define FLAG_HIDE_TARC3_NIGHT_MONS                  (TARC3_RESERVED_FLAGS_START + 0x89)
#define FLAG_HIDE_TARC3_CABIN_RAN_NIGHT             (TARC3_RESERVED_FLAGS_START + 0x8A)
#define FLAG_HIDE_TARC3_NIGHT_ICHIRO                (TARC3_RESERVED_FLAGS_START + 0x8B)
#define FLAG_HIDE_TARC3_DEST_RAN                    (TARC3_RESERVED_FLAGS_START + 0x8C)
#define FLAG_HIDE_TARC3_DEST_OFFICER_A              (TARC3_RESERVED_FLAGS_START + 0x8D)
#define FLAG_HIDE_TARC3_DEST_OFFICER_B              (TARC3_RESERVED_FLAGS_START + 0x8E)
#define FLAG_HIDE_TARC3_DEST_ICHIRO                 (TARC3_RESERVED_FLAGS_START + 0x8F)
#define FLAG_HIDE_TARC3_DEST_NATSUE                 (TARC3_RESERVED_FLAGS_START + 0x90)
#define FLAG_HIDE_TARC3_DEST_TAKESHI                (TARC3_RESERVED_FLAGS_START + 0x91)
#define FLAG_HIDE_TARC3_DEST_MARIKO                 (TARC3_RESERVED_FLAGS_START + 0x92)
#define FLAG_HIDE_TARC3_DEST_SUITMAN                (TARC3_RESERVED_FLAGS_START + 0x93)
#define FLAG_HIDE_TARC3_DEST_AKIE                   (TARC3_RESERVED_FLAGS_START + 0x94)
#define FLAG_TARC3_DEBUG_ENDING_PICKER              (TARC3_RESERVED_FLAGS_START + 0x95)
